...
public class TestScene extends AbstractScene {
	...
	public TestScene(MTApplication mtApplication, String name) {
		...
		String fileMap = "../VirtualStoryteller/img/mt4jdemo/map_pirates.PNG";
		PImage imgMap = mtApplication.loadImage(fileMap);
		
		boolean tiled = false;

		// GIVES ACCESS VIOLATION, WHY???
		MTBackgroundImage mtbiMap = new MTBackgroundImage(mtApplication, imgMap, tiled);
		getCanvas().addChild(mtbiMap);
	}

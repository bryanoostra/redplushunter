...
public class PlotElement extends MLabeledVertex implements RSVertex
{
	 ...
	 *
	 */
	public PlotElement(String k, String n, String a, String p, String t, Instrument instr, int tm)
	{			
		super();
	 ...
	 * @param v
	 */
	public void setDetails(Vector v)
	{
		details = v;
	}
	 ...
	 * @param concept
	 */
	public Vector getDetails(String concept)
	{
...
//				System.out.println(" FOUND IT ");
	...
	public boolean equals(PlotElement pe)
	{
		...
		Vector v2 = pe.getDetails(pe.getName());

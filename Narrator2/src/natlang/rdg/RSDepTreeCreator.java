...
public class RSDepTreeCreator 
{
	 ...
	 */
	public RSDepTreeNode createVerbNode(String verb, String lb, String morph) throws NarratorException
	{		
		Entry ent=null;
		try{
			ent = lc.getEntry(verb, true);
		} catch (NullPointerException e){
			throw new NarratorException("Werkwoord niet gevonden in de lexicon: "+verb);
		}
		
		System.out.println("Creating verb node for "+ent);
		...
		{			
			...
			if (adjEnt.getPos().equals("verb"))
			{
				...
				{			
					...
					VerbInflecter v1 = new VerbInflecter();
					tmp = v1.getInflectedForm(adjEnt,LibraryConstants.PROGRESSIVE);
				}
				catch(Exception e)
				{

...
public class RelationTransformer implements RDGTransformer, LibraryConstants
{
	...
	public RelationTransformer(RSGraph g, CharacterInfo characters, LexicalChooser lc)
	{
		setGraph(g);
...
//		}				
	...
	{		
		...
		Conjunctor c = new Conjunctor(rel, cueWord, characters,lc); 

...
public class ReceiveInformBehaviour extends InformReceiver {
	...
	public boolean handleContent(ContentElement ce, ACLMessage msg) {
		...
		if (ce instanceof IncomingPerception) {
			...
			logger.warning("Received INFORM: FabulaElementDeclaration. Ignoring: I have no mechanism to mark it as OOC and I am not supposed to know this IC.");
			...
			logger.warning("Received INFORM: FabulaCausalityDeclaration. Ignoring: I have no mechanism to mark it as OOC and I am not supposed to know this IC.");
			// TODO: this information should be treated as out of character (OOC)

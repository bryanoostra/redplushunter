...
/**
 * Wrapper for GoalSchema when it is adopted by the Character agent: it gets a planner to justify its preconditions
 * 
 * @author swartjes
 *
 */
public class JustifiableGoalSchema {
	 ...
	 */
	public JustifiableGoalSchema(GoalSchema gs, String characterURI, String goals, String plan) {
			
		m_goalSchema = gs;
		m_planner = new PoPlanner();
		m_planner.setGoals(	goals); // Hardcoded :(

 ...
 */
public class MTButton extends MTRectangle implements IclickableButton {
	 ...
	 */
	public MTButton(float x, float y, PApplet pApplet) {
		super(x, y, 0, 0, pApplet);
		
		setup(pApplet);
	}
	
	public MTButton(PImage texture, PApplet pApplet) {

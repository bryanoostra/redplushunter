...
public interface ICharacterManager extends IAgentModule {
	...
	/**
	 * Determines whether given character agent is controlled by a human (via interface)
	 * 
	 * @param characterAgent the AID of a character agent
	 * @return whether the character agent is controlled by a human
	 */
	public boolean isHumanControlled(AID characterAgent);
	
	public boolean isHumanControlled(String characterURI);
	
	/**
	 * Makes a character human controlled or not.
	 * 
	 * @param characterAgent the AID of a character agent
	 * @param humanControlled whether the agent should be controlled by a human or not
	 */
	public void makeHumanControlled(AID characterAgent, boolean humanControlled);

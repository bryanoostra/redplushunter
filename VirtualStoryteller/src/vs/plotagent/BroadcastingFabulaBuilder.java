 ...
 * 	TODO: decide whether to keep this. It is OOC, everything the character is allowed to know should be sent as perceptions.
 *			Do not use until characters are able to make sure they know it OOC and not use it IC.
 * 
 * @author swartjes
 *
 */

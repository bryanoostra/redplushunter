...
rule(S, 'http://www.owl-ontologies.com/SWCRules.owl#atTransitive', T):-
	query(S, 'http://www.owl-ontologies.com/StoryWorldCore.owl#at', T).	

rule(S, 'http://www.owl-ontologies.com/SWCRules.owl#atTransitive', T):-
	query(T1, 'http://www.owl-ontologies.com/StoryWorldCore.owl#partOf', T)
,	rule(S, 'http://www.owl-ontologies.com/SWCRules.owl#atTransitive', T1).		
